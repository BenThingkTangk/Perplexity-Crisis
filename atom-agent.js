...
const MODES = {
  simple: {
    ...
    chips: [
      ...
      'Explain the no-rip-and-replace convergence layer',
      'What should Aravind, Johnny, Dmitry, Frank, Justin, Raman care about?',
    ],
  },
  cto: {
    label: 'CTO',
    greeting: 'CTO mode online. The architecture accelerated faster than the coordination layer around it. I frame this as a runtime, placement, and orchestration problem &mdash; not a CDN sale.',
    chips: [
      'Where exactly does AI Grid sit alongside AWS/Foundry/CoreWeave?',
      'Pilot success criteria · TTFT, cost/query, cache hit, egress, ownership',
  ...
  cfo: {
    label: 'CFO',
    greeting: 'CFO mode online. Token economics, egress, and SLA ownership &mdash; framed as a measurable convergence pilot, not an architectural belief.',
    chips: [
      'ROI for a 30-day constrained convergence pilot',
      'Cost-per-query targets &amp; egress reduction model',
      'Vendor / SLA consolidation upside',
      'Enterprise reliability as growth retention',
    ],
  },
  sales: {
    label: 'Sales',
    greeting: 'Sales mode online. Lead with strategic convergence and the implementation path. The front door handles the connection &mdash; AI Grid brokers where the intelligence runs.',
    chips: [
      'One-sentence pitch · convergence brief framing',
      'How to send this to Aravind &amp; the Office of CEO',
      'Objection: "we already have a public edge"',
      'Constrained workload pilot · the exact ask',
    ],
  },
};
